...
function HR() {
  ...
  const filteredCandidates = useMemo(() => {
    ...
    return candidates.filter((candidate) => {
      ...
      const skillText = Array.isArray(profile.skills)
  ...
  const allRoles = useMemo(() => {
    ...
    candidates.forEach((candidate) => {
      if (candidate.mainProfile?.role) roles.add(candidate.mainProfile.role);
    });
                ...
                >
                  ...
                  {otherResumeCount > 0 && (
                    <div style={{ marginTop: "0.7rem" }}>
                      ...
                      >
                        Also has {otherResumeCount} other resume
                        ...
                        onClick={() =>
                          navigate(`/hr/view/${profile.id}`, {
                            state: {
                              user: profile,
                              candidateAccount: candidate,
                              showOtherResumes: true,
                            },
                          })
                        }
                      >
                        Other Resumes ({otherResumeCount})
                      </button>
                    </div>
                  )}
